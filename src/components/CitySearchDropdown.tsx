...
const FALLBACK_HOTEL_CITIES: City[] = [
  { code: "119805", name: "Goa", state: "Goa", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "144306", name: "Mumbai", state: "Maharashtra", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "130443", name: "Delhi", state: "Delhi", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "111124", name: "Bangalore", state: "Karnataka", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "127343", name: "Chennai", state: "Tamil Nadu", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "145710", name: "Hyderabad", state: "Telangana", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "122175", name: "Jaipur", state: "Rajasthan", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "113128", name: "Kolkata", state: "West Bengal", source: "fallback", country_code: "IN", flag: "🇮🇳" },
  { code: "115936", name: "Dubai", state: "Dubai", source: "fallback", country_code: "AE", flag: "🇦🇪" },
  { code: "144092", name: "Bangkok", state: "Bangkok", source: "fallback", country_code: "TH", flag: "🇹🇭" },
  { code: "138703", name: "Singapore", state: "Singapore", source: "fallback", country_code: "SG", flag: "🇸🇬" },
  { code: "126632", name: "London", state: "England", source: "fallback", country_code: "GB", flag: "🇬🇧" },
  { code: "130452", name: "New York", state: "New York", source: "fallback", country_code: "US", flag: "🇺🇸" },
  { code: "131408", name: "Paris", state: "Ile-de-France", source: "fallback", country_code: "FR", flag: "🇫🇷" },
  { code: "148251", name: "Tokyo", state: "Tokyo", source: "fallback", country_code: "JP", flag: "🇯🇵" },
  { code: "110670", name: "Bali", state: "Bali", source: "fallback", country_code: "ID", flag: "🇮🇩" },
  { code: "144745", name: "Colombo", state: "Western", source: "fallback", country_code: "LK", flag: "🇱🇰" },
  { code: "127096", name: "Male", state: "Male", source: "fallback", country_code: "MV", flag: "🇲🇻" },
];
